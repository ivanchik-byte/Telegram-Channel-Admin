🇷🇺 РУССКАЯ ВЕРСИЯ ДОСТУПНА ТУТ: [README.md](README.md) | Author's Channel: [t.me/ivanchik_byte](https://t.me/ivanchik_byte)

> 🤖 **AI Agent Instructions / Fast Setup**: If you are using an AI coding agent (Claude Code, Cursor, Windsurf, Antigravity, etc.) to download and run this project, feed it the **[INSTALL.md](INSTALL.md)** guide.
...
> 🤖 **AI Agent Setup**: If you are using an AI coding agent to deploy this project, see **[INSTALL.md](INSTALL.md)** for a dedicated agent-optimized installation guide.
