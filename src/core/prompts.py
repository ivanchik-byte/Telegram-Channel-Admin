...
3. Структура и форматирование под Telegram:
   ...
   — Если уместно, в конце — короткая ремарка от себя (1 предложение). В самом конце поста можно добавить 1-2 эмодзи, но только если они органично вписываются в смысл.
