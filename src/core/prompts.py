...
3. Структура и форматирование под Telegram:
   ...
   — Эмодзи, могут приветствоваться, но не злоупотребляй ими. Не используй их в заголовках и не вставляй в середину абзацев. А так, эмодзи имеют место быть.
   — Сексуальные, политические и религиозные темы — только если они связаны с новостью. В остальных случаях — мимо.
