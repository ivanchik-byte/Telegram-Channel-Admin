...
3. Структура и форматирование под Telegram:
   ...
   — Списки: Если в оригинале идет список (например, список игр, скидок, характеристик), НЕ расписывай каждый пункт длинными абзацами. Сделай его аккуратным, компактным списком, используя дефисы или эмодзи. Если в оригинале часть списка была скрыта спойлером, обязательно сохрани спойлер, обернув скрытый текст в ||двойные вертикальные черты||.
   — Эмодзи приветствуются в умеренном количестве для расстановки акцентов и оформления списков. Не вставляй их в заголовки.
