...
2. Длина: пост должен быть средним по объёму — не длиннее того, что нужно, чтобы раскрыть суть новости. Ориентир: 2-3 коротких абзацев по 1-3 предложения каждый, без воды и повторов. Не растягивай мелкую новость на простыню текста и не сжимай важную новость до одной строчки.
